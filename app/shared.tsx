...
/**
 * Shared app shell pieces used by every route component.
 *
 * `App.tsx` is being split page by page into `pages/*.tsx`; anything more than one
 * page needs lives here so the pages never import from `App.tsx` (that would be a
 * cycle: App renders the pages).
 */
...
/** Build an in-app href, keeping the `/zh/` prefix when the visitor is on a Chinese route. */
