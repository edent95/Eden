 ...
 * what visitors see. Every proof link points at a build that already exists on this site.
 */
...
export const IGAMING_CONTACT_EMAIL = 'd.tytern@gmail.com';
export const IGAMING_LINKEDIN_URL = 'https://www.linkedin.com/in/daniel-yi-tern-tan-461567199/';
...
/** Route keys resolved to real hrefs by App.tsx. */
export type IGamingProofRoute = 'etreporthub-sales' | 'bonus-key' | 'penneys-game' | 'atlantis';

export type IGamingService = {
  id: string;
  title: IGamingLocalized;
  body: IGamingLocalized;
  proof: IGamingLocalized;
  route: IGamingProofRoute;
};
...
export const IGAMING_PAGE = {
  ...
  ctaPrimary: L('Talk about your operation', '聊聊你的运营'),
  ctaSecondary: L('See what I build', '看我做什么'),
  ...
  services: [
    {
      ...
      proof: L('ETReportHub · RM4,890 launch package', 'ETReportHub · RM4,890 上线套餐'),
      route: 'etreporthub-sales',
    },
    {
      id: 'campaigns',
      ...
      proof: L('1+1 Bonus Key Combo Builder', '1+1 奖金密钥组合构建器'),
      route: 'bonus-key',
    },
    {
      id: 'games',
      ...
      proof: L("Mini Coin Slot · Penney's Game", "Mini Coin Slot · Penney's Game"),
      route: 'penneys-game',
    },
    {
      id: 'pages',
      ...
      proof: L('Atlantis website UI/UX prototype', 'Atlantis 网站 UI/UX 原型'),
      route: 'atlantis',
    },
  ] as IGamingService[],
  ...
  contactTitle: L('Bring the report that hurts most.', '带上最头痛的那份报表。'),
  contactBody: L(
    'Send one report, one campaign, or one feature that keeps breaking. I will tell you whether a system fixes it, and what the smallest version looks like.',
    '发来一份报表、一个活动，或一个总出问题的功能。我会告诉你系统能不能解决，以及最小版本长什么样。',
  ),
  contactEmailLabel: L('Email', '邮件'),
  contactLinkedinLabel: L('LinkedIn', 'LinkedIn'),
